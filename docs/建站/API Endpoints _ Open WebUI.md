...
#### Triggering Outlet Processing[​](#triggering-outlet-processing "Direct link to Triggering Outlet Processing")
...
#### Checking File Processing Status[​](#checking-file-processing-status "Direct link to Checking File Processing Status")
...
#### Processing Web URLs into Knowledge Collections[​](#processing-web-urls-into-knowledge-collections "Direct link to Processing Web URLs into Knowledge Collections")
